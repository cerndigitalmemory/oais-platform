...
from oais_platform.oais.statistics import count_steps_by_status, step_statistics_counts
...
class TagViewSet(viewsets.ReadOnlyModelViewSet, PaginationMixin):
    ...
    def edit_tag(self, request, pk=None):
        ...
        is_duplicate = check_for_tag_name_duplicate(title, request.user, tag.id)
...
def check_for_tag_name_duplicate(title, creator, tag_id=None):
    """
