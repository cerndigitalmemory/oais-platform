# Generated by Django 5.0.6 on 2024-06-20 14:20
...
def add_sources(apps, schema_editor):
    ...
    Source.objects.create(name="opendata", longname="CERN OpenData Portal", api_url="https://opendata.cern.ch/api", classname="Invenio", has_restricted_records=False)
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('oais', '0013_profile_cds_rdm_api_key_and_more'),
